...
// path params = Path parameters are dynamic segments of a URL that allow you to capture values from the URL path and pass them to your route handlers in an Express.js application. it give only the value which you request as a response.
